const apesAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256[]", name: "extraMetls", type: "uint256[]" },
    ],
    name: "addExtraMetl",
    outputs: [],
    stateMutability: "nonpayable",
    ...
    outputs: [
      {
        ...
        internalType: "struct VenturePass.TokenReward[]",
        name: "",
        type: "tuple[]",
      },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "dr", type: "uint256" }],
    name: "changeDaysRequired",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "contract MembershipForge", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
